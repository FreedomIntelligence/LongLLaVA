...
if __name__ == "__main__":
    ...
    GT = get_gt(
        data_path='./benchmarks/MME/MME_Benchmark_release_version'
    )

    experiment = args.experiment

    result_dir = os.path.join('./benchmarks/MME/eval_tool', 'answers', experiment)
    os.makedirs(result_dir, exist_ok=True)

    answers = [json.loads(line) for line in open(os.path.join('./benchmarks/MME/answers', f'{experiment}.jsonl'))]
